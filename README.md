...
2. 阅读知识图谱、大模型相关相关硕博论文和《计算机学报》《软件学报》《计算机研究与发展》三大学报上的论文，然后阅读英文论文，精读有代码的论文(https://paperswithcode.com/task/knowledge-graphs) (https://paperswithcode.com/task/language-modelling) (https://videolectures.net/search?query=knowledge%20graph&tab=lectures)明确选题方向！

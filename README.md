...
- [研究生时间规划](#研究生时间规划)
- [蒲慕明院士写给实验室研究生的Email](#蒲慕明院士写给实验室研究生的Email)
...
- [中国计算机学会CCF推荐国际学术会议和期刊目录2022](#中国计算机学会CCF推荐国际学术会议和期刊目录2022)
- [知识图谱相关会议](#知识图谱相关会议)
- [知识图谱相关期刊](#知识图谱相关期刊)
- [如何做科研写论文](#如何做科研写论文)
- [知识图谱系统](#知识图谱系统)
...
### 研究生时间规划
####  研一第一学期
1. 研究生阶段完成一篇综述（对应大论文的一二章）、两篇创新点论文（申博士的同学三篇）（对应大论文的三四章），参与工程项目（对应大论文的最后一章）。保证学习时间，上午9点到12点，下午2:00到6:30，晚上7:30点到10:30，**每天不间断（寒暑假继续，国家法定节假日除外）**，如果有事情耽误，第二天补上! **申博英语六级成绩最低分要求：复旦计算机学院425，大数据学院500；浙大计算机学院460；东南大学网安学院425！**
2. 阅读知识图谱、大模型相关相关硕博论文和《计算机学报》《软件学报》《计算机研究与发展》三大学报上的论文，然后阅读英文论文，精读有代码的论文，观看videolectures相关学术报告，明确选题方向！(https://paperswithcode.com/task/knowledge-graphs) (https://paperswithcode.com/task/language-modelling) (https://videolectures.net/search?query=knowledge%20graph&tab=lectures)
3. 组会进行论文阅读汇报，并同导师讨论，**开始撰写综述（提前预选投稿杂志)，寒假结束前完成**。引用的近三年文献占70%以上（CCF A类或者SCI一区以上(https://www.aminer.cn/search/pub?conf_tag=cjcr-1%E5%8C%BA%2Cccf-a&q=knowledge%20graph&t=b&time=2021-2024)

#### 研一第二学期
1. **开学第一个月完成综述文章投搞！（中科院SCI二区以上期刊）**
2. 复现基线方法的代码，构思第一个创新点！并撰写论文初稿！
3. **第二学期结束前，第一个创新点论文一定要投出去(中科院SCI二区以上或者CCF A类)，同时提交对应的专利申请稿**
#### 研二第一学期
...
4. 加紧实验，整理数据，准备开题，**开题前第二个创新点文章要投出去(中科院SCI二区以上或者CCF A类)，同时提交对应的专利申请稿**
#### 研二第二学期
1. 第三个创新点文章一定要有雏形，加紧实验，同时，还是要多和导师进行沟通，保持正确的大方向。**暑假前第三个创新点文章要投出去(中科院SCI二区以上或者CCF A类)，同时提交对应的专利申请稿** （申请读博的同学要投第三个创新点论文）
#### 研三第一学期
1. 博士申请、找工作。
2. 撰写毕业论文，国庆后第一周出大论文框架，在寒假回家前，完成初稿，送给小同行评审。
#### 研三第二学期
1. 开学前大论文要写改好，准备送外审！准备毕业答辩！
--- 
### 蒲慕明院士写给实验室研究生的Email
1. [蒲慕明院士写给实验室研究生的Email](https://zhuanlan.zhihu.com/p/61681895)
--- 
### 研究生从事学术研究的赫曼法则
